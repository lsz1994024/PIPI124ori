...
//        if (scanNum == 49408){
//            System.out.println("49408 virtual ");
//            for (Map.Entry<Float, Float> p : plMap.entrySet()){
//                System.out.print((p.getKey()-massTable.get("PROTON"))+" ");
//            }
//            System.out.println("49408 virtual end ");
//        }
//        if (scanNum == 49408){
//            System.out.print("fixedMe = [");
//            for (Float i : plMap.keySet()){
//                System.out.print( (i -massTable.get("PROTON"))+ " ," );
//            }
//            System.out.println("]");
//
//            System.out.print("fixedIe = [");
//            for (Float i : plMap.keySet()){
//                System.out.print( plMap.get(i) + " ," );
//            }
//            System.out.println("]");
//        }
    ...
    private TreeMap<Float, Float> addVirtualPeaks(SpectrumEntry spectrumEntry, int scan) {
...
//                if (scan == 49408){
//
//                    System.out.println("another "+anotherMz);
//                }
            }
        }
