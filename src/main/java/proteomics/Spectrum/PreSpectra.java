...
//                        String[] temp = title.split("\\.");
                        scanNum = getScanNum(title);
                    }
                } catch (Exception ex) {}

//                if (scanNum == 49408){
//                    System.out.println(" LSZ here 49408");
//                }

                TreeMap<Float, Float> plMap = preSpectrumObj.preSpectrum(rawMzIntensityMap, precursorMass, precursorCharge, ms2Tolerance, scanNum);
